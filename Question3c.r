...
plot_genotype_distribution <- function(simulated_genotypes, individual_id, scenario_name) {
  genotype_counts <- count_genotype_frequency(simulated_genotypes, individual_id)
  barplot(genotype_counts, main = paste("Genotype Distribution for Individual", individual_id, "under", scenario_name),
          xlab = "Genotype", ylab = "Frequency", col = rainbow(length(genotype_counts)))
}

# Plot genotype distribution for individual 8 under each scenario
plot_genotype_distribution(scenario1_simulated_genotypes, "8", "Scenario 1")
plot_genotype_distribution(scenario2_simulated_genotypes, "8", "Scenario 2")
plot_genotype_distribution(scenario3_simulated_genotypes, "8", "Scenario 3")

# Plot genotype distribution for individual 11 under each scenario
plot_genotype_distribution(scenario1_simulated_genotypes, "11", "Scenario 1")
plot_genotype_distribution(scenario2_simulated_genotypes, "11", "Scenario 2")
plot_genotype_distribution(scenario3_simulated_genotypes, "11", "Scenario 3")
